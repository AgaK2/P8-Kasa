...
function Logement() {
    ...
    const { id } = useParams() // ID de la propriété pour laquelle les photos sont chargées. UseParams est utilisé pour récupérer les paramètres d'une URL.
    ...
    // Si les données du logement ne sont pas encore téléchargées, un message s'affichera.
    if (!logementData) {
